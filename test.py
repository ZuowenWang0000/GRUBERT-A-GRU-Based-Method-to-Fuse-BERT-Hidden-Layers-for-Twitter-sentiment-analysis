...
def test_bert_mix(eval_loader, model, criterion, device, config, tf_writer, epoch, embedder):
    """
...
def test_bert_mix_two(eval_loader, model, criterion, device, config, tf_writer, epoch, embedder):
    """
    Performs one epoch's training.
...
def test_bert_mix_six(eval_loader, model, criterion, device, config, tf_writer, epoch, embedder):
    """
    Performs one epoch's training.
